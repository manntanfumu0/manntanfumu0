I work at the intersection of data engineering and business analytics — my focus is building trustworthy data pipelines and translating them into decisions that actually move the needle.
Currently developing hands-on expertise across the Modern Data Stack: SQL, dbt, Python, BigQuery, and Power BI. My projects are designed around real business questions in sectors like banking, e-commerce, and marketing — not just technical exercises.
I'm actively seeking my first role as a Data Analyst Jr or Analytics Engineer Jr, where I can contribute to real problems, grow fast, and help teams trust their data.
...
<img src="https://raw.githubusercontent.com/gilbarbara/logos/main/logos/snowflake-icon.svg" height="50" alt="Snowflake" title="Snowflake"/>
